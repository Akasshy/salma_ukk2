    ...
    <div class="container mt-50 vh-100 d-flex justify-content-center align-items-center">
            <div class="card-content" style="margin-top: 5%; margin-left:200px;">
                ...
                <div class="card-body mt-20">
                    <h3 class="fw-bold">User update</h3>
                    <form class="form form-vertical" action="/user/update/{{ $user->id }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="form-body">
                            <div class="row">
                                <div class="col-10">
                                ...
                                <div class="col-10 mt-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="contact-info-vertical"
                                            ...
                                            placeholder="Masukkan nisn" value="{{ $user->nisn }}">
                                    </div>
                                </div>
                                <div class="col-10 mt-4">
                                    <div class="form-group">
                                        <label for="role" class="form=-label">Kelas</label>
                                        <select id="kelas" name="grade_level" required>
