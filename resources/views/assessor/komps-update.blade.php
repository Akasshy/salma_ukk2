...
<div class="container mt-50 vh-100 d-flex justify-content-center align-items-center">
        <div class="card-content" style="margin-top: 5%; margin-left:200px;">
            ...
            <div class="card-body mt-20">
                ...
                <form class="form form-vertical" action="/kompsss-update/{{ $compentencyStandard->id }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="form-body">
                        <div class="row">
                            <div class="col-10">
                            ...
                            <div class="col-10 mt-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="contact-info-vertical"
                                        class="form-control" name="major_name"
                                        placeholder="Masukkan major" value="{{ $compentencyStandard->major_name}}">
                                        @error('major_name')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                </div>
                            ...
                            <div class="col-10 mt-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="assessor_id" class="form-control" name="assessor_id" placeholder="Masukkan assessor" value="{{ $compentencyStandard->assessor_id }}">
                                </div>
                            </div>
                            <div class="col-10 mt-4">
