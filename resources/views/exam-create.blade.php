            ...
            <div class="container mt-50 ">
                <div class="card-content" style="margin-top: -5%; margin-left:200px;">
                    ...
                    <div class="card-body mt-20">
                        <h3 class="fw-bold">Tambahkan</h3>
                        <form class="form form-vertical" action="/exam-create" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="form-body">
                                <div class="row">
                                    ...
                                    <div class="col-10 mt-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" @error('assessor_id') is-invalid @enderror name="assessor_id" placeholder="Masukkan assessor">
                                                ...
                                                <option value="{{ $assessor->id }}" >{{ $assessor->user->name }}</option>
                                                @endforeach
                                            </select>
                                            @error('assessor_id')
                                            <small class="text-danger">{{ $message }}</small>
                                    ...
                                    <div class="col-10 mt-4">
                                        <div class="form-group">
                                            <label for="element_id">Competency Element</label>
                                            <select class="form-select" @error('element_id') is-invalid @enderror name="element_id" placeholder="Masukkan assessor">
                                                @foreach ($elements as $element )
                                                <option value="{{ $element->id }}" >{{ $element->criteria}}</option>
                                                @endforeach
                                            </select>
                                            @error('assessor_id')
                                            <small class="text-danger">{{ $message }}</small>
